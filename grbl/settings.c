...
uint8_t settings_store_global_setting(uint8_t parameter, float value) {
  ...
  if (parameter >= AXIS_SETTINGS_START_VAL) {
    ...
    switch(parameter) {
      ...
      case 30: break; // Re-initialize spindle rpm calibration  //settings.rpm_max = value; spindle_init();
      case 31: break; // Re-initialize spindle rpm calibration //settings.rpm_min = value; spindle_init();
      case 32:
